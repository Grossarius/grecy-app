        ...
        {Object.keys(allRes).map((key) => (
          <div key={key} className="capitalize">
            <Link
              ...
              <p className="text-3xl font-normal text-white transition ease-in-out duration-500  hover:font-medium mb-2">{key}</p>
            </Link>
...
function BuyList({ id, buyList }: { id: string; buyList: Product[] }) {
  ...
  return (
    <div className="flex-col space-y-6">
      ...
      {totalPrice > 0 && (
        <div className="">
          <p className="text-2xl font-bold text-white">Total Price: {totalPrice}</p>
        </div>
      )}
    </div>
  );
    ...
    <div className="Parent">
        ...
        <div className="flex h-screen w-3/5 justify-center items-center bg-bg1 " id="right">
          <div className="flex w-[750px] h-[750px] sm:scale-75 md:scale-75 lg:scale-100 shrink-0 grow-0 justify-center items-center bg-accent1 rounded-full">
            <div
              ...
              id="img">
              <div className='flex h-1/2 w-1/2 justify-end bg-[url("/bag.png")] bg-cover bg-center my-5' id="img2"></div>
            </div>
      ...
      <div className="flex h-fit w-full bg-bg1 py-24">
        <div className="flex-col w-full px-48 space-y-48 text-text1">
          ...
          <div className="flex-col">
            {buyList.length > 0 && 
            <div className="flex-col bg-accent1 px-24 py-24 space-y-12 rounded-lg" id='wrapper'>
              <h1 className="text-5xl font-medium text-white">Grocery List</h1>
